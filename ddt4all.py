...
class Main_widget(widgets.QMainWindow):
    def __init__(self, parent=None):
        ...
        self.ecunamemap = {}
        self.plugins = {}
        self.setWindowTitle(_("DDT4All macOs Version"))
...
class portChooser(widgets.QDialog):
    def __init__(self):
        ...
        self.usbbutton.setFixedHeight(100)
        self.usbbutton.setFixedWidth(100)
        ...
        self.wifibutton.setFixedHeight(100)
        self.wifibutton.setFixedWidth(100)
        ...
        self.btbutton.setFixedHeight(100)
        self.btbutton.setFixedWidth(100)
        ...
        self.obdlinkbutton.setFixedHeight(100)
        self.obdlinkbutton.setFixedWidth(100)
        ...
        self.elsbutton.setFixedHeight(100)
        self.elsbutton.setFixedWidth(100)
        ...
        self.setWindowTitle("DDT4All macOs Version")
